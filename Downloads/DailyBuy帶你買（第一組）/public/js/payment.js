                         ...
                         <tbody>
                             ...
                             <tr class=" border-black font_size">
                                ...
                                <th scope="col" class="text-center align-middle p-1"><input style="width: 80px;" type="number"
                                 ...
                                 <option value="0NT.">0NT.(面交)</option>
                                 <option value="80NT.">80NT.(宅配)</option>
                                 
                             </select>
                           
                             </th>
                                 <th scope="col" class="text-center align-middle p-1" id='product_price'>${parseInt(val.spec1_price)}NT.</th>
                             </tr>
                         </tbody>
                     </table>
                 </div>
